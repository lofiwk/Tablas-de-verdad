...
# Función para calcular las salidas según el enunciado "i"
def calcular_salidas(filas):
    # Por defecto, todas las ampolletas están apagadas
    return [0, 0, 0, 0]
...
wb = Workbook()
ws = wb.active
ws.title = "Tabla de Verdad Enunciado I"
...
output_path = os.path.join(script_dir, "tabla_verdad_i_con_casos.xlsx")
wb.save(output_path)
